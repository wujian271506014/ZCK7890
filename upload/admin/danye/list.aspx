<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="list.aspx.cs" Inherits="Tc.Web.Admin.danye.list" %>
            ...
            <asp:Repeater ID="rp_list" runat="server">
                <ItemTemplate>
                    <tr align="center" bgcolor="#FFFFFF" height="26" onmousemove="javascript:this.bgColor='#FCFDEE';"
                        ...
                        <td><%#Eval("name") %></td>
                        <td><%#LibCache.get_zidian_name(Eval("fenlei").ToString().GetInt()) %></td>
                        <td><%#Eval("ename") %></td>
                        <td>
            ...
            <tr align="center" bgcolor="#F9FCEF" height="28">
                <td colspan="8">
                    <webdiyer:AspNetPager ID="aspnetpage" runat="server" FirstPageText="首页" LastPageText="尾页"
                        ...
                        SubmitButtonText="Go" TextAfterPageIndexBox="页" TextBeforePageIndexBox="转到" PageSize="20" LayoutType="Div">
