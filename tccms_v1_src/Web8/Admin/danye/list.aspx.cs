...
namespace Tc.Web.Admin.danye
{
    public partial class list : AdminBase
    {
        ...
        private void bind()
        {
            ...
            var sumcount = 0;
            DataTable dt = BLL.BLLP.Instance.Get_Page_List("TcDanye", "id desc", aspnetpage.StartRecordIndex, aspnetpage.PageSize, where, out sumcount);
        ...
        protected void lbtnDel_Click(object sender, EventArgs e)
        {
            ...
            if (lbtn != null)
            {
                ...
                BLL.TcDanye.Instance.Delete(id);
                this.bind();//重新绑定
            }
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (strDels.Length > 0)
            {
                try
                {
                    BLL.TcDanye.Instance.DeleteList(strDels);
